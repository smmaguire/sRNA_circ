...
htseq-count --nonunique=all -f bam -a 0 $bc"_mapped_sorted.bam" /home/smaguire/work/sRNA_circ/spades/genome_ref/homo_sapiens.GRCh38.gtf > $bc"_all_non_coding_counts.txt"
